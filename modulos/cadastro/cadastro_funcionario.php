            ...
            <div class="row">
                ...
                <div class="col-md-6 col-md-offset-3">
                  ...
                  <div class="box box-primary">
                    ...
                    <!-- form start -->
                    <form id="cadastro_funcionario" name="cadastro_funcionario" action="cadastrar_funcionario.php" method="post">
                      <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-xs-5">
                                ...
                                <div class="input-group">
                                  ...
                                  <input type="text" id="telefone_residencial" name="telefone_residencial" class="form-control" data-inputmask='"mask": "(99) 9999-9999"' data-mask/>
                                </div><!-- /.input group -->
                            </div>
                            ...
                            <div class="col-xs-5">
                                ...
                                <div class="input-group">
                                  ...
                                  <input type="text" id="telefone_celular" name="telefone_celular" class="form-control" data-inputmask='"mask": "(99) 99999-9999"' data-mask/>
                                </div><!-- /.input group -->
                            </div>
