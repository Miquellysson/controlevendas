...
if ( isset( $_GET['consultar'] ) && $_GET['consultar'] == 1 ){
    ...
    $produtos = $produtoDAO->buscaProdutos( $_POST['descricao'] );
    //print_r($produtos);
    //echo '<br/><br/><br/>';
}
//$validaPreco = preg_match("/^[0-9]+$/", '123');
//var_dump($validaPreco);
?>
<!DOCTYPE html>
<html>
  <head>
      ...
      <div class="content-wrapper">
        <div class="container-fluid">
          ...
          <section class="content">
                ...
                <div class="col-md-6 col-md-offset-3">
                  ...
                  <div class="box box-primary">
                    ...
                    <div class="box-header">
                      <h3 class="box-title"> Consulta de produtos </h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    <form name="consulta_produto" action="consulta_produto.php?consultar=1" method="post">
                      <div class="box-body">
            ...
            <?php
            if( isset($produtos) && $_GET['consultar'] == 1 ){
