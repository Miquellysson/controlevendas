...
<html>
  ...
  <body class="skin-blue layout-top-nav">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-md-offset-3">
                  ...
                  <div class="box box-primary">
                    ...
                    <!-- form start -->
                    <form id="despesas_receitas" name="despesas_receitas" action="despesas_receitas_pdf.php" method="post">
                      <div class="box-body">  
    ...
    <script src="../../dist/js/relatorio_despesas_receitas.js" type="text/javascript"></script>
