...
if ( isset( $_GET['consultar'] ) && $_GET['consultar'] == 1 ){
    ...
    //print_r($vendas); //echo '<br/><br/><br/>'; //die;
}
?>
<!DOCTYPE html>
<html>
      ...
      <div class="content-wrapper">
        <div class="container-fluid">
          ...
          <section class="content">
                ...
                <div class="col-md-6 col-md-offset-3">
                  ...
                  <div class="box box-primary">
                    ...
                    <div class="box-header">
                      <h3 class="box-title"> Consulta de compras </h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    <form name="consulta_compras" action="consulta_compra.php?consultar=1" method="post">
                      <div class="box-body">
            ...
            <?php
            if( isset($compras) && $_GET['consultar'] == 1 ){
                include_once 'listar_compras.php';
            }
            ?> 
