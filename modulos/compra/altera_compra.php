...
$compra = $compraDAO->buscaCompraPorId($idCompra);
?>
<!DOCTYPE html>
<html>
  <head>
                ...
                <div class="col-md-6 col-md-offset-3">
                  ...
                  <div class="box box-primary">
                    ...
                    <div class="box-header">
                      <h3 class="box-title"> Alterar compra </h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    <form name="alterar_compra" action="alterar_compra.php" method="post">
                      <div class="box-body">
                        <input type="hidden" name="id_compra" value="<?php echo $compra[0]['id_compra']; ?>">    
                        <div class="row">
                            <div class="col-md-6">
                                <label for="valor"> Valor </label>
                                <input type="text" class="form-control" name="valor" value="<?php echo str_replace(".",",",$compra[0]['valor']); ?>" >
                            </div>
